...
export default function App() {
  ...
  useEffect(() => {
    const backgroundSubscription = Notifications.addNotificationResponseReceivedListener(res => {
      console.log(res);
    });

    const foregroundSubscription = Notifications.addNotificationReceivedListener(not => {
      console.log(not);
    });
    return () => {
